...
public class Pessoa {
    ...
    @Override
    // Detalhe: Só está verificando o nome dos objetos
    // Logo se mudar outra coisa da objeto Pessoa, como naturalidade, continuará interpretando como iguais.
    // O certo é escolher algo que não mude, como CPF ou um ID único.
    public boolean equals(Object obj) {
        if ((nome.equals(((Pessoa) obj).nome)) && (obj instanceof Pessoa))
            return true;
        else
            return false;
    }
